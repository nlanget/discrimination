...
class BinaryClassTests_2f(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.x={}
    self.x[1]=np.array([1,0.5,2,1.6,2.3,5,6,7,6.2,5.6])
    self.x[2]=np.array([4,2,3,1.5,3.2,5,4,3.5,6,4.5])
    ...
    self.x_new={}
    self.x_new[1]=np.array([2,5])
    self.x_new[2]=np.array([2,6])
...
class BinaryClassTests_3f(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.x={}
    self.x[1]=np.array([1,2,1.6,2.3,4.1,6,5.6,4.9])
    self.x[2]=np.array([1,0.5,0.8,1.5,5,3.2,4.6,4])
    self.x[3]=np.array([6,5.5,6.4,5.9,2.2,4.1,3.6,1.9])
    self.x = pd.DataFrame(self.x)
    ...
    self.x_new={}
    self.x_new[1]=np.array([2,5])
    self.x_new[2]=np.array([1,6])
    self.x_new[3]=np.array([5,2])
    self.x_new = pd.DataFrame(self.x_new)
...
class MultiClassTests(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.x={}
    self.x[1]=np.array([1,2.5,1.6,2.5,2,1.5,5.5,5,6])
    self.x[2]=np.array([4,3.5,4.5,1.2,2,1.5,3.5,4,5])
    self.x = pd.DataFrame(self.x) 
    ...
    self.x_new={}
    self.x_new[1]=np.array([3,4.5,3])
    self.x_new[2]=np.array([2,3,4.5])
    self.x_new = pd.DataFrame(self.x_new)
